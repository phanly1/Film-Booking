...
public class FantaFilmController {
    @Autowired
...
//            List<Movie> listmovie = (List<Movie>) service.showPhimDangChieu();
        ...
        return "users/FantaFilm";
    }

    @GetMapping("/movie/edit/{id}")
    public String chiTietPhim(@PathVariable("id") String id, Model model, HttpServletRequest request) {
...
//        }
    ...
    public  String showDangChieu(Model model, HttpServletRequest request,
                                 @RequestParam(value = "keyword", required = false) String keyword,
                                 @RequestParam(value = "status", required = false) String status,
                                 @RequestParam(value = "director", required = false) String directors,
                                 @RequestParam(value = "movieType", required = false) String movieTypes,
